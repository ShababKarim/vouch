        ...
        <main className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
          <div className="mb-8 flex items-center justify-between">
            <div>
              ...
              <p className="mt-1 text-sm text-gray-600">Your upcoming and past events</p>
            </div>
            ...
            <div className="flex items-center space-x-2">
              ...
              <div className="flex space-x-2">
                ...
                <button
                  ...
                  className={`rounded-md px-3 py-1 text-sm ${
                    filter === 'upcoming' ? 'bg-blue-100 text-blue-700' : 'text-gray-500 hover:text-gray-700'
                  }`}
                >
                  Upcoming
                </button>
                <button
                  ...
                  className={`rounded-md px-3 py-1 text-sm ${
                    filter === 'past' ? 'bg-blue-100 text-blue-700' : 'text-gray-500 hover:text-gray-700'
                  }`}
                >
                  Past
                </button>
